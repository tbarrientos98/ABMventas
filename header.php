...
if (!isset($_SESSION["nombre"])) { //Pregunta si existe la sesion nombre
    header("Location: login.php");
}

if ($_POST) {

    if (isset($_POST["btnCerrar"])) { //Analizamos si es la acción del botón cerrar
        session_destroy();
        header("Location: login.php");
    }
}
            ...
            <li class="nav-item">
                ...
                <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="tipoproductos.php">Tipo de producto</a>
                    </div>
                </div>
            </li>
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                ...
                                <img class="img-profile rounded-circle" src="img/fotocuenta.jpg"> <!-- foto de inicio de session -->
                            </a>
