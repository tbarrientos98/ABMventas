...
//Comprobamos que el usuario sea admin y la clave sea admin123
   $usuario = trim($_POST["txtUsuario"]); //trim elimina los espacios laterales
            ...
            <div class="card o-hidden border-0 shadow-lg my-5">
               <div class="card-body p-0">
                  ...
                  <div class="row text-center">
                     <div class="col-lg-6 d-lg-block"><img src="img/macbook-pro-2764678.jpg" style="border: none; height:35em; width:30em;" class="img-fluid"  alt=""></div>
                     <div class="col-lg-6">
                        <div class="p-5">
